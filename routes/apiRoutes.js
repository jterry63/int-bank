...
router.get("/db/user", function (req, res) {
  ...
  var dbQuery = `SELECT birthdate, credit_score, email, first_name, gender, user_id, last_name, metadata, phone, zip_code FROM freedb_intbank3f7a4412d234dgdsfusers WHERE user_id='${req.query.user_id}'`;
...
router.post("/db/users", function (req, res) {
  ...
  var dbQuery = "INSERT INTO freedb_intbank3f7a4412d234dgdsfusers (birthdate, credit_score, email, first_name, gender, user_id, last_name, metadata, phone, zip_code) VALUES (?,?,?,?,?,?,?,?,?,?)";
...
router.post("/db/accounts", function (req, res) {
  ...
  var dbQuery = "INSERT INTO freedb_intbank3f7a4412d234dgdsfaccounts (account_type, account_name, balance, available_balance, account_number, currency_code, account_id, user_id) VALUES (?,?,?,?,?,?,?,?)";
...
router.post("/db/transactions", function (req, res) {
  ...
  var dbQuery = "INSERT INTO freedb_intbank3f7a4412d234dgdsftransactions (transaction_id, transaction_status, transaction_type, amount, transaction_description, transacted_on, posted_on, category, user_id, account_id) VALUES (?,?,?,?,?,?,?,?,?,?)";
...
router.post("/int-bank/sessions", function (req, res) {
  ...
  var dbQuery = `SELECT user_id FROM freedb_intbank3f7a4412d234dgdsfusers WHERE user_id='${req.body.mdx.session[0].userkey[0]}'`;
...
router.get("/int-bank/accounts", function (req, res) {
  ...
  var dbQuery = `SELECT account_type, account_name, balance, available_balance, account_number, currency_code, account_id, user_id FROM freedb_intbank3f7a4412d234dgdsfaccounts WHERE user_id='${req.header('MDX-Session-Key')}'`;
...
router.get("/int-bank/accounts/:account_id/transactions", function (req, res) {
  ...
  var dbQuery = `SELECT transaction_id, transaction_status, transaction_type, amount, transaction_description, transacted_on, posted_on, category, user_id, account_id FROM freedb_intbank3f7a4412d234dgdsftransactions WHERE account_id='${req.params.account_id}'`;
